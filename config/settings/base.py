...
MIGRATION_MODULES = {"sites": "app_src.contrib.sites.migrations"}
...
PA_USERNAME = env("PA_USERNAME", None)
PA_DOMAIN_NAME = env("PA_DOMAIN_NAME", None)
PA_TOKEN = env("PA_TOKEN", None)
